    ...
    <div class="content">
    	<div style=" background: #286950; ">
    		<span style="font-size: 20px; ">
    					...
    					<span>
    						<a href="dh_choxacnhan.php" style="color: yellowgreen; ">Chờ xác nhận </a>
			...
			<div class="cartpage">
						...
						<table >
							...
							<tr>
								...
								<td></td>
								<td>
								 	<a class="btn btn-danger" href="?confirmid=<?php echo $customer_id ?>&time=<?php echo $result['date_order'] ?>"><i class="fas fa-window-close"></i> Hủy đơn</a>

								 	<a class="btn btn-primary" href="chitietdonhang.php?date_order=<?php echo $result['date_order'] ?>"><i class="fas fa-info-circle"></i> Chi tiết đơn hàng</a>
