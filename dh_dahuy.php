			...
			<div class="cartpage">
						...
						<table >
							...
							<tr >
								...
								<td style="margin-left: auto; font-size: 20px; color: red;"><?php echo 'Giá : '.$result['price'].' VND' ?></td>
								<td> &ensp; </td>
							...
							<tr>
								...
								<td>
								 	<a class="btn btn-warning" href="?confirmid=<?php echo $customer_id ?>&time=<?php echo $result['date_order'] ?>"><i class="fas fa-angle-double-left"></i> Mua lại</a>
