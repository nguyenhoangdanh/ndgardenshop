    	...
    	<div class="cartoption">		
			<div class="cartpage">
						...
						<table >
							...
							<tr>
								<td style="background: white; float: left; font-size: 20px; text-align: center;"><?php echo $result['productName'] ?></td>
								<td> &ensp; </td>
							...
							<tr>
								...
								<td><a class="btn btn-warning" href="chitietdonhang_danhan.php?date_order=<?php echo $result['date_order'] ?>"><i class="fas fa-info-circle"> Chi tiết đơn hàng</a></td>
							</tr>
