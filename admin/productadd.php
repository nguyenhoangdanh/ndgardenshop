...
<div class="grid_10">
    <div class="box round first grid" style="background: #f8fcf9;height: 600px; box-shadow: 5px 7px #068d74; border-radius: 5px;">
        <h2 style="background: #657a5d; color: #27d36c">Thêm sản phẩm</h2>
        <?php 
            if(isset($insertProduct)){
                echo $insertProduct;
            }
         ?>   
        <div class="block" style="background: #99b7ac">
         ...
         <form action="productadd.php"  method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <input name="product_code" type="text" placeholder="Nhập mã sản phẩm..." class="medium" />
                    </td>
                </tr>
                  <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <select id="select" name="brand">
                            <option>Chọn loại sản phẩm</option>
                            <?php 
                            $brand = new brand();
