...
<?php
  ...
  ?>
<div class="grid_10">
    <div class="box round first grid" style="background: #f8fcf9;height: 900px; box-shadow: 5px 7px #068d74; border-radius: 5px;">
        <h2 style="background: #657a5d; color: #27d36c">Sửa sản phẩm</h2>
        <?php 
         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    <td></td>
                    <td>
                        <input class="btn btn-success" type="submit" name="submit" value="Cập nhật" />
                    </td>
                </tr>
            </table>
            </form>
